...
sensor = "false"
# address_df<-c()
url_gen = paste0(root, return.call, "?address=","八德路三段12巷5弄22號", "&sensor=", sensor)
...
# ===================算距離=============================
station_locaion<-read.table(file ="station_latlng.txt",fileEncoding = "utf8",header = T,sep = ",",stringsAsFactors = F)
load("~/dsR/park.RData")
